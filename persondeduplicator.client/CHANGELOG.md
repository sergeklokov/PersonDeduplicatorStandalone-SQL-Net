...
- Create Angular project with ng: `ng new persondeduplicator.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`persondeduplicator.client.esproj`).
